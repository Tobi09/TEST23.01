...
function handleRegister() {
    ...
    if(u != '' && p!= '' && p_wdh!='' && email!='') {
		...
		if (p==p_wdh) {
			...
			console.log("passw�erter nicht identisch");
			alert("Passw�rter nicht identisch");
			navigator.notification.alert("Passw�rter nicht identisch", function() {});
		}
    } else { 
        //Thanks Igor!
		console.log("keine angaben");
...
$(document).delegate('#deleteAccount', 'click', function() {
  $(this).simpledialog({
    ...
    'buttons' : {
      ...
      'Cancel': { //Abbrechen
        click: function () {
          console.log("Account l�schen abgebrochen!");
		icon: "abbort"
      }
	 } 
    }
